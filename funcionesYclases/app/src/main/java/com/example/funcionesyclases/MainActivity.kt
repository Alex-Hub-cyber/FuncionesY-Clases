...
class MainActivity : AppCompatActivity() {
    ...
    fun clases(){
        val personas1=Estudiantes("Kimberlyn",23, arrayOf(Estudiantes.lengua.java,Estudiantes.lengua.javaScript))
        println(personas1.nombre)
        personas1.edad=22
        println(personas1.codigo())
        val persona2= Estudiantes("alex", 33, arrayOf(Estudiantes.lengua.Kotlin, Estudiantes.lengua.php),
            arrayOf(personas1 ))
